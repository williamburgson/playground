...
const (
	Echo_UnaryEcho_FullMethodName                  = "/api.Echo/UnaryEcho"
	Echo_ServerStreamingEcho_FullMethodName        = "/api.Echo/ServerStreamingEcho"
	Echo_ClientStreamingEcho_FullMethodName        = "/api.Echo/ClientStreamingEcho"
	Echo_BidirectionalStreamingEcho_FullMethodName = "/api.Echo/BidirectionalStreamingEcho"
)
